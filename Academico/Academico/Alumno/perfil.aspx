...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="col-md-12 col-xs-12">
        ...
        <div class="x_panel">
            <div class="x_title">
                <h2>Datos Personales<small>perfil del alumno registrado:</small><small class="text-primary">
                    <asp:Label runat="server" ID="etAlumno"></asp:Label></small> </h2>
            ...
            <div class="x_content">
                ...
                <div class="form-horizontal form-label-left input_mask">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12 well well-sm">
                        <asp:Image runat="server" ID="ImgPerfilUsuario" ImageUrl="~/Imagenes/anonimo.jpg" CssClass="img-responsive"  />
                    </div>
